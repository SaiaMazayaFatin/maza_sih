  ...
  return (
    <footer className="py-3 sm:py-4">
      <div className="flex flex-col items-center">
        {/* Social Links */}
        <div className="flex space-x-3 sm:space-x-4 mb-2">
          <a
            href="https://github.com/SaiaMazayaFatin"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/saiamazayafatin/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
            aria-label="LinkedIn"
          ...
          <a
            href="https://www.instagram.com/maza_sih/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
